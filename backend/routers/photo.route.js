...
import { getSignedUrlForEvent, getSignedUrlForSelfie, createSelfie, downloadAll, downloadSelected, deletePhoto, deleteSelfie } from "../controllers/photo.controller.js";
...
photoRouter.route("/delete/selfie/:collectionId").delete(verifyStrictJWT, deleteSelfie); // Test
